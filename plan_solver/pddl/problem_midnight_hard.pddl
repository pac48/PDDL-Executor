...
(:objects
    ...
    nathan - Person
    t1 t2 t3 t4 t5 t6 - Time    ;; t7 t8
    automated_msg recorded_msg recorded_msg_2 call_caregiver_outside_msg call_caregiver_bed_msg call_emergency_msg call_emergency_msg_2 - Msg
    automated_reminder recorded_reminder recorded_reminder_2 - ReminderAction
    caregiver_call emergency_call emergency_call_2 caregiver_call_bed - CallAction
)
(:init
    ...
    (reminder_blocks_call recorded_reminder_2 caregiver_call_bed)
